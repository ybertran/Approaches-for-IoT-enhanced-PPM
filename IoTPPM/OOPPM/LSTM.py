...
class Model(nn.Module):
    def __init__(self, vocab_size, num_numerical_features, dropout, lstm_size, num_classes):
        ...
        self.lstm = nn.LSTM(self.vocab_size[0] + self.num_numerical_features, self.vocab_size[0], dropout=self.lstm_dropout, num_layers=self.lstm_size, batch_first=True)
    ...
    def forward(self, x_act, x_num):
        ...
        l1_out, _ = self.lstm(combined_input)
        output = l1_out[:, -1, :]
